...
//    var cartasBem = Model.shared.cartas.filter({$0.doBem})
    ...
    var instrucao = [
        "O jogo poderá ser jogado entre 6 e 8 jogadores, o jogador poderá ser um organizador (simbolo rosa) ou um desorganizador (simbolo roxo) ou o palhaço, que possui o objetivo de atrapalhar os demais jogadores. ",
        "O jogo é composto por etapas, os organizadores possuem o objetivo de fazer que essas etapas sejam realizadas com sucesso, enquanto os desorganizadores irão fazer de tudo para fazer com que as etapas falhem e a festa seja mal sucedida.",
        "O jogador não sabe  o papel dos demais jogadores, criando uma desconfiança entre eles. A cada rodada é escolhido um líder, esse líder é responsável por escolher 3 jogadores para realizar a etapa, os jogadores escolhidos votarão secretamente se a etapa falhará ou será um sucesso.",
        "Caso os organizadores façam 4 pontos, o Penetra poderá ver a identidade do bêbado. Caso os desorganizadores façam 3 pontos, o Distraído poderá trocar de papel com o palhaço. ",
        "O número de rodadas é a mesma quantidade de jogadores, possibilitando que cada jogadore se torne lider uma vez, assim que as rodadas acabarem, os organizadores devem apontar para quem eles acham que são os desorganizadores, lembrando que se o palhaço for o  mais votado ele ganha o jogo, e os desorganizadores devem apontar para os organizadores, tentando enganar todos e ganhar o jogo",
        "Os organizadores ganham se descobrirem quem são os desorganizadores. Os desorganizadores ganham se enganarem todos para que votem nos organizadores. O palhaço ganha a maioria dos votos sejam nele."
    ]
    private init(){}
}
